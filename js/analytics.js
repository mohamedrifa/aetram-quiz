...
(function ($) {
  ...
  var chartDefaults = {
    color: '#c9983e',
    borderColor: 'rgba(217, 179, 90, 0.3)',
  ...
  function initCharts() {
    ...
    charts.line = new Chart($('#chart-line')[0], {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: '#c9983e',
          backgroundColor: 'rgba(217, 179, 90, 0.1)',
          fill: true,
          tension: 0.4
        }]
      },
    ...
    charts.bar = new Chart($('#chart-bar')[0], {
      ...
      data: {
        ...
        datasets: [{
          label: 'Avg Score',
          data: [88, 85, 82, 79, 84],
          backgroundColor: 'rgba(217, 179, 90, 0.6)',
          borderColor: '#c9983e',
          borderWidth: 1
        }]
      },
    ...
    charts.donut = new Chart($('#chart-donut')[0], {
      ...
      data: {
        labels: ['5★', '4★', '3★', '2★', '1★'],
        datasets: [{ data: [45, 30, 15, 7, 3], backgroundColor: ['#e5bf69', '#c9983e', '#b9812f', '#6b7280', '#ef4444'] }]
      },
    ...
    charts.area = new Chart($('#chart-area')[0], {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: '#c9983e',
          backgroundColor: 'rgba(217, 179, 90, 0.2)',
          fill: true,
          tension: 0.3
        }]
      },
